...
System.register("npm:babel-runtime@5.2.17/helpers/class-call-check", [], true, function(require, exports, module) {
...
System.register("src/app/homePage/controllers/LmaController", ["npm:babel-runtime@5.2.17/helpers/class-call-check"], function (_export) {
	var _classCallCheck, LmaController;
	...
	return {
		...
		execute: function () {
			...
			LmaController = function LmaController($scope) {
				_classCallCheck(this, LmaController);
			...
			_export("default", LmaController);
		}
	};
});
System.register('src/app/app', ['github:angular/bower-angular@1.3.15', 'src/app/homePage/controllers/LmaController'], function (_export) {
	var angular, LmaController, appModule;
	return {
		setters: [function (_githubAngularBowerAngular1315) {
			angular = _githubAngularBowerAngular1315['default'];
		}, function (_srcAppHomePageControllersLmaController) {
			LmaController = _srcAppHomePageControllersLmaController['default'];
		}],
		execute: function () {
			'use strict';
